...
- [ ] Download project dependencies by running one of these two commands `yarn`
      or `npm install`
- [ ] Using the same command tool (yarn or npm) start up the app using
...
- [ ] Plan which components will hold state, what data each needs from props (if
